  ...
  <div class="s-center">
    ...
    <div class="cont-register" v-else-if="showState === 'register'">
      ...
      <div class="form-item">
        ...
        <input name="password" type="password" placeholder="请输入密码" maxlength="6" v-model="dataLogin.pass">
        <button class="btn-get" href="javascript:;">眼睛</button>
      </div>
    ...
    <div class="cont-login" v-else-if="showState === 'logining'">
      ...
      <div class="form-item">
        ...
        <input name="password" type="password" placeholder="请输入密码" maxlength="6" v-model="dataLogin.pass">
        <button class="btn-get">眼睛</button>
      </div>
